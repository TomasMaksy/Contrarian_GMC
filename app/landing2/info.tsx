...
export const Info = () => {
	return (
		<main className="dark relative overflow-hidden flex flex-col gap-12 mt-12">
			...
			<section className="md:pt-20 bg-[radial-gradient(ellipse_60%_900%_at_left,rgba(10,109,173,0.6),black)] overflow-x-clip mb-48 ">
